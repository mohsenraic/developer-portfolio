        ...
        <Fade left duration={1000}>
            <Card style={{flex: 1}} className="shadow-lg--hover shadow border-0 text-center rounded mb-5">
                ...
                <CardBody className="py-5">
                    <img ref={imgRef} className=" bg-white mb-3 rounded-circle img-center img-fluid shadow-lg " src={data.companylogo} style={{ width: "100px" }} onLoad={() => getColorArrays()} alt=""/>
                    ...
                    <div>
                        <img className=" bg-white mb-3 rounded-circle img-center img-fluid shadow-lg " src={data.screenshot} alt=""/>
